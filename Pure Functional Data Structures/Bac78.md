...
적용형 컴퓨터 시스템의 이력 민감성과 저장공간의 부재는 그들이 컴퓨터 디자인의 기틀을 제공하지 못한 주요 원인입니다. 더욱이, 가장 적용적인 시스템들은 람다 대수의 부분 연산들을 그들의 기본 연산으로 채용했습니다. 이 연산들은 가장적으로 무제한적인 힘 중 하나이나, 그들의 완전하고 효율적인 현실화는 기계 설계자에게 큰 어려움을 제공합니다. 더욱이, 저장소를 가져와 폰 노이만 시스템의 효율성을 향상시키는 노력은 적응형 시스템들로 하여금 큰 폰 노이만 시스템에 휩싸이게끔 하는 경향을 띕니다.
